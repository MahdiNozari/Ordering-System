...
<body>
    ...
    <header class="navbar text-center navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="{{ route('home') }}">webprog.io</a>
        ...
        <div class="navbar-nav">
            <div class="nav-item text-nowrap d-flex align-items-center">
                @auth
                    <span class="nav-link text-white">{{ Illuminate\Support\Facades\Auth::user()->name }}</span>
